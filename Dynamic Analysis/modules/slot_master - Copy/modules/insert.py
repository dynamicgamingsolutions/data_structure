...
def insert_setup(row, date, conn, creds, project):
    ...
    casino_df = pd.DataFrame(casino, columns=['sql_casino','official_casino','casino_id','casino_abrv','back_os','sql_tribe','official_tribe','state','address_full','address','city','state_abbreviation','zip','Longitude','Latitude'])
